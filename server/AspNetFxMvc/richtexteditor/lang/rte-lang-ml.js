...
RTE_DefaultConfig.text_inserttodolist = "ചെയ്യേണ്ട ലിസ്റ്റ്";	//"Todo List"
RTE_DefaultConfig.text_casechange = "കേസ് മാറ്റുക";	//"Change Case"
RTE_DefaultConfig.text_formatpainter = "ഫോർമാറ്റ് പെയിന്റർ";	//"Format Painter"
RTE_DefaultConfig.text_insertmergefield = "ലയന ഫീൽഡ്";	//"Insert Merge Field"
RTE_DefaultConfig.text_insertfootnote = "അടിക്കുറിപ്പ്";	//"Insert Footnote"
RTE_DefaultConfig.text_inserttoc = "ഉള്ളടക്ക പട്ടിക";	//"Table of Contents"
RTE_DefaultConfig.text_insertpagebreak = "പേജ് ബ്രേക്ക്";	//"Page Break"
RTE_DefaultConfig.text_importword = "Word ഇറക്കുമതി";	//"Import Word"
RTE_DefaultConfig.text_exportword = "Word കയറ്റുമതി";	//"Export Word"
RTE_DefaultConfig.text_exportpdf = "PDF കയറ്റുമതി";	//"Export PDF"
RTE_DefaultConfig.text_insertcomment = "കുറിപ്പ്";	//"Insert Comment"
RTE_DefaultConfig.text_trackchanges = "മാറ്റങ്ങൾ ട്രാക്ക് ചെയ്യുക";	//"Track Changes"
RTE_DefaultConfig.text_insertmention = "പരാമർശം";	//"Mention"
RTE_DefaultConfig.text_revisionhistory = "പതിപ്പ് ചരിത്രം";	//"Revision History"
RTE_DefaultConfig.text_multilevellist = "മൾട്ടി-ലെവൽ ലിസ്റ്റ്";	//"Multi-Level List"
RTE_DefaultConfig.text_autoformatting = "ഓട്ടോ ഫോർമാറ്റിംഗ്";	//"Auto Formatting"
RTE_DefaultConfig.text_insertbookmark = "ബുക്ക്മാർക്ക്";	//"Bookmark"
RTE_DefaultConfig.text_spellcheck = "അക്ഷരത്തെറ്റ് പരിശോധന";	//"Spell Check"
RTE_DefaultConfig.text_formatblock = "ഖണ്ഡിക ഫോർമാറ്റ്";	//"Paragraph Format"
RTE_DefaultConfig.text_linethrough = "സ്ട്രൈക്ക്ത്രൂ";	//"Strikethrough"
RTE_DefaultConfig.text_ltr = "ഇടത്തുനിന്ന് വലത്തേക്ക്";	//"Left to Right"
RTE_DefaultConfig.text_rtl = "വലത്തുനിന്ന് ഇടത്തേക്ക്";	//"Right to Left"
RTE_DefaultConfig.text_COMMON = "പൊതുവായ";	//"Common"
RTE_DefaultConfig.text_FORMAT = "ഫോർമാറ്റ്";	//"Format"
RTE_DefaultConfig.text_PARAGRAPHS = "ഖണ്ഡികകൾ";	//"Paragraphs"
RTE_DefaultConfig.text_INSERT = "ചേർക്കുക";	//"Insert"

RTE_DefaultConfig.text_styles = "ശൈലികൾ";	//"Styles"
RTE_DefaultConfig.text_inlinestyles = "ടെക്സ്റ്റ് ശൈലികൾ";	//"Text styles"
