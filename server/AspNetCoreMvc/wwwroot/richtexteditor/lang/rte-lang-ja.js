...
RTE_DefaultConfig.text_inserttodolist = "タスクリスト";	//"Todo List"
RTE_DefaultConfig.text_casechange = "大文字小文字変換";	//"Change Case"
RTE_DefaultConfig.text_formatpainter = "書式のコピー";	//"Format Painter"
RTE_DefaultConfig.text_insertmergefield = "差し込みフィールド";	//"Insert Merge Field"
RTE_DefaultConfig.text_insertfootnote = "脚注";	//"Insert Footnote"
RTE_DefaultConfig.text_inserttoc = "目次";	//"Table of Contents"
RTE_DefaultConfig.text_insertpagebreak = "改ページ";	//"Page Break"
RTE_DefaultConfig.text_importword = "Word取込";	//"Import Word"
RTE_DefaultConfig.text_exportword = "Word出力";	//"Export Word"
RTE_DefaultConfig.text_exportpdf = "PDF出力";	//"Export PDF"
RTE_DefaultConfig.text_insertcomment = "コメント";	//"Insert Comment"
RTE_DefaultConfig.text_trackchanges = "変更履歴";	//"Track Changes"
RTE_DefaultConfig.text_insertmention = "メンション";	//"Mention"
RTE_DefaultConfig.text_revisionhistory = "変更履歴";	//"Revision History"
RTE_DefaultConfig.text_multilevellist = "多段リスト";	//"Multi-Level List"
RTE_DefaultConfig.text_autoformatting = "自動書式";	//"Auto Formatting"
RTE_DefaultConfig.text_insertbookmark = "ブックマーク";	//"Bookmark"
RTE_DefaultConfig.text_spellcheck = "スペルチェック";	//"Spell Check"
RTE_DefaultConfig.text_formatblock = "段落書式";	//"Paragraph Format"
RTE_DefaultConfig.text_linethrough = "取り消し線";	//"Strikethrough"
RTE_DefaultConfig.text_ltr = "左から右";	//"Left to Right"
RTE_DefaultConfig.text_rtl = "右から左";	//"Right to Left"
RTE_DefaultConfig.text_COMMON = "共通";	//"Common"
RTE_DefaultConfig.text_FORMAT = "書式";	//"Format"
RTE_DefaultConfig.text_PARAGRAPHS = "段落";	//"Paragraphs"
RTE_DefaultConfig.text_INSERT = "挿入";	//"Insert"

RTE_DefaultConfig.text_styles = "スタイル";	//"Styles"
RTE_DefaultConfig.text_inlinestyles = "テキスト スタイル";	//"Text styles"
