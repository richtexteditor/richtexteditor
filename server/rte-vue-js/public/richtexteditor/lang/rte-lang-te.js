...
RTE_DefaultConfig.text_inserttodolist = "చేయవలసిన పనుల జాబితా";	//"Todo List"
RTE_DefaultConfig.text_casechange = "కేసు మార్పు";	//"Change Case"
RTE_DefaultConfig.text_formatpainter = "ఫార్మాట్ పెయింటర్";	//"Format Painter"
RTE_DefaultConfig.text_insertmergefield = "విలీన ఫీల్డ్";	//"Insert Merge Field"
RTE_DefaultConfig.text_insertfootnote = "అడుగు గమనిక";	//"Insert Footnote"
RTE_DefaultConfig.text_inserttoc = "విషయ సూచిక";	//"Table of Contents"
RTE_DefaultConfig.text_insertpagebreak = "పేజీ విరామం";	//"Page Break"
RTE_DefaultConfig.text_importword = "Word దిగుమతి";	//"Import Word"
RTE_DefaultConfig.text_exportword = "Word ఎగుమతి";	//"Export Word"
RTE_DefaultConfig.text_exportpdf = "PDF ఎగుమతి";	//"Export PDF"
RTE_DefaultConfig.text_insertcomment = "వ్యాఖ్య";	//"Insert Comment"
RTE_DefaultConfig.text_trackchanges = "మార్పులను ట్రాక్ చేయండి";	//"Track Changes"
RTE_DefaultConfig.text_insertmention = "ప్రస్తావన";	//"Mention"
RTE_DefaultConfig.text_revisionhistory = "సవరణ చరిత్ర";	//"Revision History"
RTE_DefaultConfig.text_multilevellist = "బహుళ-స్థాయి జాబితా";	//"Multi-Level List"
RTE_DefaultConfig.text_autoformatting = "ఆటో ఫార్మాటింగ్";	//"Auto Formatting"
RTE_DefaultConfig.text_insertbookmark = "బుక్‌మార్క్";	//"Bookmark"
RTE_DefaultConfig.text_spellcheck = "అక్షర దోష పరీక్ష";	//"Spell Check"
RTE_DefaultConfig.text_formatblock = "పేరా ఫార్మాట్";	//"Paragraph Format"
RTE_DefaultConfig.text_linethrough = "స్ట్రైక్‌త్రూ";	//"Strikethrough"
RTE_DefaultConfig.text_ltr = "ఎడమ నుండి కుడి";	//"Left to Right"
RTE_DefaultConfig.text_rtl = "కుడి నుండి ఎడమ";	//"Right to Left"
RTE_DefaultConfig.text_COMMON = "సాధారణ";	//"Common"
RTE_DefaultConfig.text_FORMAT = "ఫార్మాట్";	//"Format"
RTE_DefaultConfig.text_PARAGRAPHS = "పేరాలు";	//"Paragraphs"
RTE_DefaultConfig.text_INSERT = "చేర్చు";	//"Insert"

RTE_DefaultConfig.text_styles = "శైలులు";	//"Styles"
RTE_DefaultConfig.text_inlinestyles = "వచన శైలులు";	//"Text styles"
