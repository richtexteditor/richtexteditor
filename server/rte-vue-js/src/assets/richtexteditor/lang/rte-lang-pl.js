...
RTE_DefaultConfig.text_inserttodolist = "Lista zadań";	//"Todo List"
RTE_DefaultConfig.text_casechange = "Zmień wielkość liter";	//"Change Case"
RTE_DefaultConfig.text_formatpainter = "Malarz formatów";	//"Format Painter"
RTE_DefaultConfig.text_insertmergefield = "Pole korespondencji seryjnej";	//"Insert Merge Field"
RTE_DefaultConfig.text_insertfootnote = "Przypis dolny";	//"Insert Footnote"
RTE_DefaultConfig.text_inserttoc = "Spis treści";	//"Table of Contents"
RTE_DefaultConfig.text_insertpagebreak = "Podział strony";	//"Page Break"
RTE_DefaultConfig.text_importword = "Importuj Word";	//"Import Word"
RTE_DefaultConfig.text_exportword = "Eksportuj Word";	//"Export Word"
RTE_DefaultConfig.text_exportpdf = "Eksportuj PDF";	//"Export PDF"
RTE_DefaultConfig.text_insertcomment = "Komentarz";	//"Insert Comment"
RTE_DefaultConfig.text_trackchanges = "Śledź zmiany";	//"Track Changes"
RTE_DefaultConfig.text_insertmention = "Wzmianka";	//"Mention"
RTE_DefaultConfig.text_revisionhistory = "Historia zmian";	//"Revision History"
RTE_DefaultConfig.text_multilevellist = "Lista wielopoziomowa";	//"Multi-Level List"
RTE_DefaultConfig.text_autoformatting = "Automatyczne formatowanie";	//"Auto Formatting"
RTE_DefaultConfig.text_insertbookmark = "Zakładka";	//"Bookmark"
RTE_DefaultConfig.text_spellcheck = "Sprawdzanie pisowni";	//"Spell Check"
RTE_DefaultConfig.text_formatblock = "Format akapitu";	//"Paragraph Format"
RTE_DefaultConfig.text_linethrough = "Przekreślenie";	//"Strikethrough"
RTE_DefaultConfig.text_ltr = "Od lewej do prawej";	//"Left to Right"
RTE_DefaultConfig.text_rtl = "Od prawej do lewej";	//"Right to Left"
RTE_DefaultConfig.text_COMMON = "Ogólne";	//"Common"
RTE_DefaultConfig.text_FORMAT = "Format";	//"Format"
RTE_DefaultConfig.text_PARAGRAPHS = "Akapity";	//"Paragraphs"
RTE_DefaultConfig.text_INSERT = "Wstaw";	//"Insert"

RTE_DefaultConfig.text_styles = "Style";	//"Styles"
RTE_DefaultConfig.text_inlinestyles = "Style tekstu";	//"Text styles"
