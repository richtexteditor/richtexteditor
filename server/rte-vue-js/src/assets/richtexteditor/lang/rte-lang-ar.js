...
RTE_DefaultConfig.text_inserttodolist = "قائمة المهام";	//"Todo List"
RTE_DefaultConfig.text_casechange = "تغيير الحالة";	//"Change Case"
RTE_DefaultConfig.text_formatpainter = "نسخ التنسيق";	//"Format Painter"
RTE_DefaultConfig.text_insertmergefield = "حقل دمج";	//"Insert Merge Field"
RTE_DefaultConfig.text_insertfootnote = "حاشية سفلية";	//"Insert Footnote"
RTE_DefaultConfig.text_inserttoc = "جدول المحتويات";	//"Table of Contents"
RTE_DefaultConfig.text_insertpagebreak = "فاصل صفحات";	//"Page Break"
RTE_DefaultConfig.text_importword = "استيراد Word";	//"Import Word"
RTE_DefaultConfig.text_exportword = "تصدير Word";	//"Export Word"
RTE_DefaultConfig.text_exportpdf = "تصدير PDF";	//"Export PDF"
RTE_DefaultConfig.text_insertcomment = "تعليق";	//"Insert Comment"
RTE_DefaultConfig.text_trackchanges = "تعقب التغييرات";	//"Track Changes"
RTE_DefaultConfig.text_insertmention = "إشارة";	//"Mention"
RTE_DefaultConfig.text_revisionhistory = "سجل المراجعة";	//"Revision History"
RTE_DefaultConfig.text_multilevellist = "قائمة متعددة المستويات";	//"Multi-Level List"
RTE_DefaultConfig.text_autoformatting = "تنسيق تلقائي";	//"Auto Formatting"
RTE_DefaultConfig.text_insertbookmark = "إشارة مرجعية";	//"Bookmark"
RTE_DefaultConfig.text_spellcheck = "التدقيق الإملائي";	//"Spell Check"
RTE_DefaultConfig.text_formatblock = "تنسيق الفقرة";	//"Paragraph Format"
RTE_DefaultConfig.text_linethrough = "يتوسطه خط";	//"Strikethrough"
RTE_DefaultConfig.text_ltr = "من اليسار إلى اليمين";	//"Left to Right"
RTE_DefaultConfig.text_rtl = "من اليمين إلى اليسار";	//"Right to Left"
RTE_DefaultConfig.text_COMMON = "عام";	//"Common"
RTE_DefaultConfig.text_FORMAT = "تنسيق";	//"Format"
RTE_DefaultConfig.text_PARAGRAPHS = "فقرات";	//"Paragraphs"
RTE_DefaultConfig.text_INSERT = "إدراج";	//"Insert"

RTE_DefaultConfig.text_styles = "الأنماط";	//"Styles"
RTE_DefaultConfig.text_inlinestyles = "أنماط النص";	//"Text styles"
