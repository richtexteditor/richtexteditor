...
RTE_DefaultConfig.text_inserttodolist = "Listă de sarcini";	//"Todo List"
RTE_DefaultConfig.text_casechange = "Schimbă majuscule";	//"Change Case"
RTE_DefaultConfig.text_formatpainter = "Copiere format";	//"Format Painter"
RTE_DefaultConfig.text_insertmergefield = "Câmp de îmbinare";	//"Insert Merge Field"
RTE_DefaultConfig.text_insertfootnote = "Notă de subsol";	//"Insert Footnote"
RTE_DefaultConfig.text_inserttoc = "Cuprins";	//"Table of Contents"
RTE_DefaultConfig.text_insertpagebreak = "Întrerupere de pagină";	//"Page Break"
RTE_DefaultConfig.text_importword = "Importă Word";	//"Import Word"
RTE_DefaultConfig.text_exportword = "Exportă Word";	//"Export Word"
RTE_DefaultConfig.text_exportpdf = "Exportă PDF";	//"Export PDF"
RTE_DefaultConfig.text_insertcomment = "Comentariu";	//"Insert Comment"
RTE_DefaultConfig.text_trackchanges = "Urmărire modificări";	//"Track Changes"
RTE_DefaultConfig.text_insertmention = "Mențiune";	//"Mention"
RTE_DefaultConfig.text_revisionhistory = "Istoric revizuiri";	//"Revision History"
RTE_DefaultConfig.text_multilevellist = "Listă cu mai multe niveluri";	//"Multi-Level List"
RTE_DefaultConfig.text_autoformatting = "Formatare automată";	//"Auto Formatting"
RTE_DefaultConfig.text_insertbookmark = "Semn de carte";	//"Bookmark"
RTE_DefaultConfig.text_spellcheck = "Verificare ortografică";	//"Spell Check"
RTE_DefaultConfig.text_formatblock = "Format paragraf";	//"Paragraph Format"
RTE_DefaultConfig.text_linethrough = "Tăiat";	//"Strikethrough"
RTE_DefaultConfig.text_ltr = "Stânga la dreapta";	//"Left to Right"
RTE_DefaultConfig.text_rtl = "Dreapta la stânga";	//"Right to Left"
RTE_DefaultConfig.text_COMMON = "General";	//"Common"
RTE_DefaultConfig.text_FORMAT = "Format";	//"Format"
RTE_DefaultConfig.text_PARAGRAPHS = "Paragrafe";	//"Paragraphs"
RTE_DefaultConfig.text_INSERT = "Inserare";	//"Insert"

RTE_DefaultConfig.text_styles = "Stiluri";	//"Styles"
RTE_DefaultConfig.text_inlinestyles = "Stiluri de text";	//"Text styles"
