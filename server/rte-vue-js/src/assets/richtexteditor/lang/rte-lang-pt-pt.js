...
RTE_DefaultConfig.text_inserttodolist = "Lista de tarefas";	//"Todo List"
RTE_DefaultConfig.text_casechange = "Alterar maiúsculas";	//"Change Case"
RTE_DefaultConfig.text_formatpainter = "Pincel de formatação";	//"Format Painter"
RTE_DefaultConfig.text_insertmergefield = "Campo de mesclagem";	//"Insert Merge Field"
RTE_DefaultConfig.text_insertfootnote = "Nota de rodapé";	//"Insert Footnote"
RTE_DefaultConfig.text_inserttoc = "Índice";	//"Table of Contents"
RTE_DefaultConfig.text_insertpagebreak = "Quebra de página";	//"Page Break"
RTE_DefaultConfig.text_importword = "Importar Word";	//"Import Word"
RTE_DefaultConfig.text_exportword = "Exportar Word";	//"Export Word"
RTE_DefaultConfig.text_exportpdf = "Exportar PDF";	//"Export PDF"
RTE_DefaultConfig.text_insertcomment = "Comentário";	//"Insert Comment"
RTE_DefaultConfig.text_trackchanges = "Controlar alterações";	//"Track Changes"
RTE_DefaultConfig.text_insertmention = "Menção";	//"Mention"
RTE_DefaultConfig.text_revisionhistory = "Histórico de revisões";	//"Revision History"
RTE_DefaultConfig.text_multilevellist = "Lista multinível";	//"Multi-Level List"
RTE_DefaultConfig.text_autoformatting = "Formatação automática";	//"Auto Formatting"
RTE_DefaultConfig.text_insertbookmark = "Marcador";	//"Bookmark"
RTE_DefaultConfig.text_spellcheck = "Verificação ortográfica";	//"Spell Check"
RTE_DefaultConfig.text_formatblock = "Formato de parágrafo";	//"Paragraph Format"
RTE_DefaultConfig.text_linethrough = "Tachado";	//"Strikethrough"
RTE_DefaultConfig.text_ltr = "Esquerda para direita";	//"Left to Right"
RTE_DefaultConfig.text_rtl = "Direita para esquerda";	//"Right to Left"
RTE_DefaultConfig.text_COMMON = "Comum";	//"Common"
RTE_DefaultConfig.text_FORMAT = "Formato";	//"Format"
RTE_DefaultConfig.text_PARAGRAPHS = "Parágrafos";	//"Paragraphs"
RTE_DefaultConfig.text_INSERT = "Inserir";	//"Insert"

RTE_DefaultConfig.text_styles = "Estilos";	//"Styles"
RTE_DefaultConfig.text_inlinestyles = "Estilos de texto";	//"Text styles"
