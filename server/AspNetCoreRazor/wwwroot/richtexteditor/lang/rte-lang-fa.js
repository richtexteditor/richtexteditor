...
RTE_DefaultConfig.text_inserttodolist = "فهرست کارها";	//"Todo List"
RTE_DefaultConfig.text_casechange = "تغییر حالت حروف";	//"Change Case"
RTE_DefaultConfig.text_formatpainter = "قالب‌بردار";	//"Format Painter"
RTE_DefaultConfig.text_insertmergefield = "فیلد ادغام";	//"Insert Merge Field"
RTE_DefaultConfig.text_insertfootnote = "پاورقی";	//"Insert Footnote"
RTE_DefaultConfig.text_inserttoc = "فهرست مطالب";	//"Table of Contents"
RTE_DefaultConfig.text_insertpagebreak = "شکست صفحه";	//"Page Break"
RTE_DefaultConfig.text_importword = "وارد کردن Word";	//"Import Word"
RTE_DefaultConfig.text_exportword = "صادر کردن Word";	//"Export Word"
RTE_DefaultConfig.text_exportpdf = "صادر کردن PDF";	//"Export PDF"
RTE_DefaultConfig.text_insertcomment = "نظر";	//"Insert Comment"
RTE_DefaultConfig.text_trackchanges = "پیگیری تغییرات";	//"Track Changes"
RTE_DefaultConfig.text_insertmention = "اشاره";	//"Mention"
RTE_DefaultConfig.text_revisionhistory = "تاریخچه بازنگری";	//"Revision History"
RTE_DefaultConfig.text_multilevellist = "فهرست چند سطحی";	//"Multi-Level List"
RTE_DefaultConfig.text_autoformatting = "قالب‌بندی خودکار";	//"Auto Formatting"
RTE_DefaultConfig.text_insertbookmark = "نشانک";	//"Bookmark"
RTE_DefaultConfig.text_spellcheck = "بررسی املا";	//"Spell Check"
RTE_DefaultConfig.text_formatblock = "قالب پاراگراف";	//"Paragraph Format"
RTE_DefaultConfig.text_linethrough = "خط‌خورده";	//"Strikethrough"
RTE_DefaultConfig.text_ltr = "چپ به راست";	//"Left to Right"
RTE_DefaultConfig.text_rtl = "راست به چپ";	//"Right to Left"
RTE_DefaultConfig.text_COMMON = "عمومی";	//"Common"
RTE_DefaultConfig.text_FORMAT = "قالب";	//"Format"
RTE_DefaultConfig.text_PARAGRAPHS = "پاراگراف‌ها";	//"Paragraphs"
RTE_DefaultConfig.text_INSERT = "درج";	//"Insert"

RTE_DefaultConfig.text_styles = "سبک‌ها";	//"Styles"
RTE_DefaultConfig.text_inlinestyles = "سبک‌های متن";	//"Text styles"
