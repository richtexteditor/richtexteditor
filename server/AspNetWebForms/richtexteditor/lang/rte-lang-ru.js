...
RTE_DefaultConfig.text_inserttodolist = "Список задач";	//"Todo List"
RTE_DefaultConfig.text_casechange = "Изменить регистр";	//"Change Case"
RTE_DefaultConfig.text_formatpainter = "Формат по образцу";	//"Format Painter"
RTE_DefaultConfig.text_insertmergefield = "Поле слияния";	//"Insert Merge Field"
RTE_DefaultConfig.text_insertfootnote = "Сноска";	//"Insert Footnote"
RTE_DefaultConfig.text_inserttoc = "Оглавление";	//"Table of Contents"
RTE_DefaultConfig.text_insertpagebreak = "Разрыв страницы";	//"Page Break"
RTE_DefaultConfig.text_importword = "Импорт Word";	//"Import Word"
RTE_DefaultConfig.text_exportword = "Экспорт Word";	//"Export Word"
RTE_DefaultConfig.text_exportpdf = "Экспорт PDF";	//"Export PDF"
RTE_DefaultConfig.text_insertcomment = "Комментарий";	//"Insert Comment"
RTE_DefaultConfig.text_trackchanges = "Отслеживание изменений";	//"Track Changes"
RTE_DefaultConfig.text_insertmention = "Упоминание";	//"Mention"
RTE_DefaultConfig.text_revisionhistory = "История изменений";	//"Revision History"
RTE_DefaultConfig.text_multilevellist = "Многоуровневый список";	//"Multi-Level List"
RTE_DefaultConfig.text_autoformatting = "Автоформатирование";	//"Auto Formatting"
RTE_DefaultConfig.text_insertbookmark = "Закладка";	//"Bookmark"
RTE_DefaultConfig.text_spellcheck = "Проверка орфографии";	//"Spell Check"
RTE_DefaultConfig.text_formatblock = "Формат абзаца";	//"Paragraph Format"
RTE_DefaultConfig.text_linethrough = "Зачёркнутый";	//"Strikethrough"
RTE_DefaultConfig.text_ltr = "Слева направо";	//"Left to Right"
RTE_DefaultConfig.text_rtl = "Справа налево";	//"Right to Left"
RTE_DefaultConfig.text_COMMON = "Общие";	//"Common"
RTE_DefaultConfig.text_FORMAT = "Формат";	//"Format"
RTE_DefaultConfig.text_PARAGRAPHS = "Абзацы";	//"Paragraphs"
RTE_DefaultConfig.text_INSERT = "Вставка";	//"Insert"

RTE_DefaultConfig.text_styles = "Стили";	//"Styles"
RTE_DefaultConfig.text_inlinestyles = "Стили текста";	//"Text styles"
